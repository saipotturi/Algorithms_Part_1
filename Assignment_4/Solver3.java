...
public class Solver3 {
	...
	public Solver3(Board initial) // find a solution to the initial board (using
									// the A* algorithm)
	{
	...
	// below)
	{
		int[][] test_array = {{5, 1, 8}, {2, 7, 3}, {4, 0, 6}};
